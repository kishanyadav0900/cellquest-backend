function QualityScope() {
  return (
    <>
      ...
      <div className="container-fluid py-5" style={{ background: "linear-gradient(135deg, #1b5e20 0%, #2e7d32 40%, #43a047 100%)" }}>
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <div className="mb-4">
                <span className="px-4 py-2 rounded-pill text-white fw-bold" style={{ background: "#e65100", fontSize: "1.1rem" }}>
                  Quality Scope
                </span>
              </div>
              ...
              <ul className="list-unstyled mt-4">
                {[
                  ...
                  <li key={i} className="d-flex align-items-start gap-3 mb-3">
                    <span className="flex-shrink-0 d-flex align-items-center justify-content-center rounded-circle" style={{ width: "10px", height: "10px", background: "#e65100", marginTop: "8px" }}></span>
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                {[
                  ...
                  <li key={i} className="d-flex align-items-start gap-3 mb-3">
                    ...
                    <span className="text-white" style={{ fontSize: "1rem", lineHeight: 1.6 }}>
                      {item.text} {item.bold && <strong style={{ color: "#ffe0b2" }}>({item.bold})</strong>}
                    </span>
                  </li>
                ))}
              </ul>
              ...
              {/* Query Management */}
              <div className="mt-4 p-4 rounded-3" style={{ background: "rgba(255,255,255,0.1)", borderLeft: "3px solid #e65100" }}>
                <h5 className="text-white mb-3" style={{ fontWeight: 700 }}>
                  <i className="bi bi-chat-dots me-2" style={{ color: "#e65100" }}></i>Query Management
                </h5>
                <ul className="list-unstyled mb-0">
                  {[
                    ...
                    <li key={i} className="d-flex align-items-start gap-2 mb-2">
                      <i className="bi bi-check2-circle flex-shrink-0" style={{ color: "#e65100", marginTop: "3px" }}></i>
              ...
              <div className="mt-4 p-4 rounded-3" style={{ background: "rgba(255,255,255,0.1)", borderLeft: "3px solid #e65100" }}>
                <h5 className="text-white mb-3" style={{ fontWeight: 700 }}>
                  <i className="bi bi-pc-display me-2" style={{ color: "#e65100" }}></i>Robust LIS
                </h5>
                <ul className="list-unstyled mb-0">
      ...
      {/* Trusted Care Banner */}
      <div className="container-fluid py-4 text-center" style={{ background: "linear-gradient(135deg, #e65100, #f57c00)" }}>
